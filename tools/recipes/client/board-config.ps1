...
# ранговости/платформы — этого пока нет. Печатаем ТОЛЬКО факт (ConfiguredClockSpeed, без
# сравнения с базой — сравнивать не с чем, см. R-M2 ниже), вердикт «сток/профиль» намеренно
# НЕ печатаем: лучше отсутствие ответа, чем уверенный неверный.
