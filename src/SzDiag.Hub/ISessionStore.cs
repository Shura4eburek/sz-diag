...
public interface ISessionStore
{
    ...
    /// <summary>Слить события из журнала клиента с уже известными. Возвращает добавленные
    /// записи: те, что hub уже видел сам (по времени ±5 минут), не дублируются (бэклог п.97).</summary>
    Task<IReadOnlyList<PowerEvent>> MergeJournalEventsAsync(PowerEventsReport report, CancellationToken ct = default);
