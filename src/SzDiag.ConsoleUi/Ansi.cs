...
public static class Ansi
{
    ...
    /// <summary>ED(0): стереть от курсора до конца экрана. Нужен при запуске панели:
    /// всё, что процесс напечатал до неё, осталось бы под панелью, и короткие новые
    /// строки не затирали бы хвосты длинных старых.</summary>
