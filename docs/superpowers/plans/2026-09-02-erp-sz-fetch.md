...
public static class ErpCommand
{
    ...
    private static int Fail(ErpApiException e)
    {
        ...
        var hint = code switch
        {
            ...
            // Ловили вживую: окно с описанием обновления (встроенный браузер поверх
            // рабочей области) обнуляет дерево автоматизации — 0 узлов вместо 127.
            // Показывается после каждого апдейта, пока его не закроют.
